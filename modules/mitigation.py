...
def train_exponentiated_gradient(X_train, y_train, sensitive_train, constraint="dp"):
    ...
    # eps=0.05 added to speed up computation 
...
class AdversarialDebiaser(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y, s):
        ...
        for i in range(self.n_iterations):
            # increase alpha from 0 to self.alpha over 500 iterations
            ...
            # Loss = Performance - (Alpha * Fairness_Penalty)
